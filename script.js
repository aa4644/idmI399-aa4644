...
//fix this part; look at Github zodiac.js in Lib folder (start with December and the last should be January); clean up
//find a way to change the images for the slimes and begin adding audio to the slimes 
...
//this function is where when the user enters a date, it will give them the corresponding slime
